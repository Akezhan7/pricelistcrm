...
const ProductWarehouseDetails = sequelize.define('ProductWarehouseDetails', {
  ...
  weight: { type: DataTypes.DECIMAL(10, 3), allowNull: false, validate: { min: 0 } },
  length: { type: DataTypes.DECIMAL(10, 2), allowNull: false, validate: { min: 0 } },
  width: { type: DataTypes.DECIMAL(10, 2), allowNull: false, validate: { min: 0 } },
  height: { type: DataTypes.DECIMAL(10, 2), allowNull: false, validate: { min: 0 } },
